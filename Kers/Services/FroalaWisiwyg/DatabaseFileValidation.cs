...
namespace Kers.Services.FroalaWisiwyg
{
    ...
    /// File Validation.
    /// </summary>
    public class DatabaseFileValidation
    {
        /// <summary>
        ...
        public DatabaseFileValidation(string[] allowedExts, string[] allowedMimeTypes)
        {
            initDefault();
        ...
        public DatabaseFileValidation(Func<string, string, bool> function)
        {
            initDefault();
