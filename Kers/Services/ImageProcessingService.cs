...
//http://www.paddo.org/asp-net-core-image-resizing-middleware/
...
namespace Kers.Services
{
    ...
    public class ImageProcessingService
    {
        ...
        public SKData Restrict(Stream image, ResizeParams resizeParams, DateTime lastWriteTimeUtc)
        {
            SKData imageData;
            ...
            if(bitmap.Width > resizeParams.w || bitmap.Height > resizeParams.h){
        ...
        public SKData GetImageData(Stream image, ResizeParams resizeParams, DateTime lastWriteTimeUtc)
        {
        ...
        public SKBitmap Crop(SKBitmap original, ResizeParams resizeParams) {
            var cropSides = 0;
            var cropTopBottom = 0;
        ...
        public ImageProcessingService(RequestDelegate next, IHostingEnvironment env, ILogger<ImageProcessingService> logger, IMemoryCache memoryCache)
        {
            _next = next;
            _env = env;
            _logger = logger;
