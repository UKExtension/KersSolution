...
namespace Kers.Tasks
{
    ...
    public class SnapSummaryByEmployeeTask : TaskBase, IScheduledTask
    {
        //KERScoreContext context;
        IServiceProvider serviceProvider;
        public SnapSummaryByEmployeeTask(
            //KERScoreContext context
            IServiceProvider serviceProvider
        ){
        ...
        public async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            using (var scope = serviceScopeFactory.CreateScope())
            {
                ...
                try{ 
                    ...
                    var str = repo.TotalByEmployee(fiscalYearRepo.currentFiscalYear(FiscalYearType.SnapEd, true), true);
                    Random rnd = new Random();
                    int RndInt = rnd.Next(1, 53);
                    if( RndInt == 2 ){
                        str = repo.TotalByEmployee(fiscalYearRepo.previoiusFiscalYear(FiscalYearType.SnapEd), true);
                    }
