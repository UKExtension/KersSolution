        ...
        public async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            using (var scope = serviceScopeFactory.CreateScope())
            {
                ...
                try{
                    ...
                    progressLog += startTime.ToString() + ": ActivityPerMajorProgramTask Started\n";
                    ...
                    if( startTime.DayOfWeek == DayOfWeek.Friday){
                        ...
                        var tblKSU = await repo.DataByMajorProgram(fiscalYearRepo.currentFiscalYear(FiscalYearType.ServiceLog),2, 0, true, 20);
                    ...
                    if( startTime.DayOfWeek == DayOfWeek.Saturday){
                        ...
                        var tblUK = await repo.DataByMajorProgram(fiscalYearRepo.currentFiscalYear(FiscalYearType.ServiceLog),3, 0, true, 20);
                    ...
                    if( startTime.DayOfWeek == DayOfWeek.Sunday){
                        ...
                        var tblAll = await repo.DataByMajorProgram(fiscalYearRepo.currentFiscalYear(FiscalYearType.ServiceLog),4, 0, true, 20);
