...
namespace Kers.Controllers
{
    ...
    public class InServiceClassicController : Controller
    {
        ...
        public InServiceClassicController( 
                    KERSmainContext mainContext,
                    KERScoreContext context,
                    KERS_SNAPED2017Context snapContext,
                    IKersUserRepository userRepo,
...
//SelectCommand="SELECT personName, catalog_TrainDateBegin, catalog_TrainDateBeginMMDDYYYY, tID, catalog_iHours, attendedYN, catalog_tTitle, catalog_tLocation, catalog_tTime FROM [UKCA_Reporting]..[vInServiceTrainingEnrollment] WHERE (personID = @kers_personID) AND (catalog_trainDateBegin BETWEEN '20160701' AND '20170630') ORDER BY catalog_trainDateBegin">
